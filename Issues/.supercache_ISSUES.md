...
> and issue tracker for **.supercache**.

---

## How to use this document

- This is the living help-desk for repo operations, CI/CD, bugs, and blockers for .supercache.
...
```
Issues/
├── .supercache_ISSUES.md       (this file — the ledger)
...
- 2026-05-02T22:15:59-0400 — Initialized issues ledger.
